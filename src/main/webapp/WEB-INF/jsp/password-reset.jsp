        ...
        <div class="wrap-login100 p-t-30 p-b-50">
            ...
            <form method="post" class="login100-form validate-form p-b-33 p-t-5">
                <div class="wrap-input100 validate-input">
                    <c:if test='${requestScope.containsKey("form")}'>
                        <form:form cssClass="login100-form validate-form p-b-33 p-t-5" modelAttribute="form">
                            ...
                            <div class="container-login100-form-btn m-t-32">
                                <input type="submit" class="login100-form-btn" title="Reset">
                            </div>
                        </form:form>
                    </c:if>
                    <c:if test='${requestScope.containsKey("token")}'>
                        <p class="ui-state-error error">${token}</p>
                    </c:if>
                </div>
            </form>
        </div>
